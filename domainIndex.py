...
domainIndex =  {"[Híbrido] Policia Nacional"     : {     "scanner": ocr.scan_PDF_PN,
                ...
                "[AI] Policia Nacional y Guardia Civil combinado": {        "scanner": ocr.scan_PDF_COMBINE_OCR_TEXT,
                                                "fileType": "PDF",
                                                "encoding": "latin-1",
                                                ...
                                                "deidentifierList" : ( [(PNanonymizers.remove_mail.__name__, PNanonymizers.remove_mail)],[(aiWORKfilters.remove_flair_nombre_persona, aiWORKfilters.gc_pn_combined_work), (aiWORKfilters.remove_flair_lugar_general, aiWORKfilters.gc_pn_combined_work), (aiWORKfilters.remove_flair_calle, aiWORKfilters.gc_pn_combined_work), (aiWORKfilters.remove_flair_id, aiWORKfilters.gc_pn_combined_work), (aiWORKfilters.remove_flair_fechas, aiWORKfilters.gc_pn_combined_work), (aiWORKfilters.remove_flair_telefono, aiWORKfilters.gc_pn_combined_work), (aiWORKfilters.remove_flair_organizacion, aiWORKfilters.gc_pn_combined_work)]) 
                                }
}